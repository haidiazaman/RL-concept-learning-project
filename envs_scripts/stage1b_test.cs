...
public class stage1b_test : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        while (otherObject1_AttributesIndex==targetAttributesIndex || testAttributesList[otherObject1_AttributesIndex].color==targetAttributes.color)
        {
        ...
        while (otherObject2_AttributesIndex==targetAttributesIndex || testAttributesList[otherObject2_AttributesIndex].color==targetAttributes.color)
        {
        ...
        while (otherObject3_AttributesIndex==targetAttributesIndex || testAttributesList[otherObject3_AttributesIndex].color==targetAttributes.color)
        {

...
public class stage1a : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        while (otherObject1_AttributesIndex==targetAttributesIndex || trainAttributesList[otherObject1_AttributesIndex].obj==targetAttributes.obj)
        {
        ...
        while (otherObject2_AttributesIndex==targetAttributesIndex || trainAttributesList[otherObject2_AttributesIndex].obj==targetAttributes.obj)
        {
        ...
        while (otherObject3_AttributesIndex==targetAttributesIndex || trainAttributesList[otherObject3_AttributesIndex].obj==targetAttributes.obj)
        {
